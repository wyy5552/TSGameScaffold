/* eslint-disable */
/**
 * thanks to https://github.com/jsroads/Cocos-Creator-PureMVC-Demo
 */
/**
...
export class View implements IView {
    ...
    registerMediator(mediator: IMediator): void {
        ...
        if (len > 0) {
            ...
            for (let i: number = 0; i < len; i++) this.registerObserver(interests[i], observer);
        }
...
export class Facade implements IFacade {
     ...
     */
    initializeController(): void {
        if (!this.controller) this.controller = Controller.getInstance();
    }
     ...
     */
    initializeView(): void {
        if (!this.view) this.view = View.getInstance();
    }
 ...
 */
export class Mediator<T> extends Notifier implements IMediator, INotifier {
    /**
